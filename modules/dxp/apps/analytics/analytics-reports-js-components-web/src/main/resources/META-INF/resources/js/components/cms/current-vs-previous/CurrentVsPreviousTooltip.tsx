...
import {MetricDataKey} from './CurrentVsPreviousChart';

interface ICurrentVsPreviousTooltipProps
...
const CurrentVsPreviousTooltip: React.FC<ICurrentVsPreviousTooltipProps> = ({
	formattedData,
	index,
	rangeSeletor,
	style,
...
export default CurrentVsPreviousTooltip;
